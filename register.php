...
<div class="container">
    ...
    <div id="main">
        <form action="function/authcode.php" id="form-1" class="form" method="POST">
            ...
            <div class="form__wrap">
                ...
                <input type="text" class="form__wrap-input" name="username" placeholder="VD: Phan Minh Quang">
            ...
            <div class="form__wrap">
                ...
                <input type="text" class="form__wrap-input" name="email" placeholder="VD: phanminhquang@gmail.com">
                <span class="form__error-message"></span>
            </div>
            <div class="form__wrap">
    ...
    <script src="./assets/js1/validation.js"></script>
    <script>
        Validation({
            form: '#form-1',
