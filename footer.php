...
<div class="container-fluid p-0">
    ...
    <footer class="bg-white text-center text-lg-start text-black">
        ...
        <div class="container p-4">
            ...
            <div class="row my-4">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0 member">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="#!" class="text-black text-decoration-none"><i class="fa-solid fa-user"></i>Phan Minh Quang</a>
                        </li>
                        <li class="mb-2">
                            <a href="#!" class="text-black text-decoration-none"><i class="fa-solid fa-user"></i>Trương Đức Nghĩa</a>
                        </li>
                        <li class="mb-2">
                            <a href="#!" class="text-black text-decoration-none"><i class="fa-solid fa-user"></i>Nguyễn Lê Kim Ngân</a>
                        </li>
        ...
        <div class="text-center p-3 copy-right" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2024 Copyright:
            <a class="text-black" href="#">Phonestore.com</a>
        </div>
        <!-- Copyright -->
    </footer>
...
<!-- Slick slider -->
<!-- link main.js -->
<script src="./assets/js1/js.js"></script>
